import { ADD_WORD_TO_SEARCH, DELETE_WORD_FROM_SEARCH, TOGGLE_WORD_VISIBILITY, SEARCH_WORDS_BEGIN, SEARCH_WORDS_SUCCESS, SEARCH_WORDS_FALIURE, EDIT_SEARCHED_WORDS, EXPORT_MODE_OFF, EXPORT_MODE_ON, ADD_WORD_EXTENSIONS_TO_EXPORT, DELETE_WORD_EXTENSION_FROM_EXPORT, CANCEL_ALL_MARK_FOR_EXPORT, EXPORT_DIALOG_TOGGLE, SHOW_EXPORT_SUCCESS, ADD_EDITED_WORD_EXTENSION, REMOVE_EDITED_WORD_EXTENSION } from "./actionTypes.js";
...
export const showExportSuccess = exportSuccessStatus => ({
...
export const addEditedWordExtension = wordInfo => ({
    type: ADD_EDITED_WORD_EXTENSION,
    payload: {
        wordInfo
    }
});

export const removeEditedWordExtension = wordInfo => ({
    type: REMOVE_EDITED_WORD_EXTENSION,
    payload: {
        wordInfo
    }
});