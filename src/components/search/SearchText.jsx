...
import { validateIsInArabic } from "../../validations/inputValidation"
...
class SearchText extends React.Component {
    addWordToSearch = chip => {
        if (validateIsInArabic(chip)) {
            this.props.addWordToSearch(chip)
        };
    };
    ...
    render() {
        ...
        return <ChipInput className={classes.root}
            value={this.props.wordsToSearch} helperText="הכניסו מילה ולחצו על Enter" onAdd={chip => this.addWordToSearch(chip)} onDelete={(chip => this.props.deleteWordFromSearch(chip))}
        />
    };
};
//todo: add validation
